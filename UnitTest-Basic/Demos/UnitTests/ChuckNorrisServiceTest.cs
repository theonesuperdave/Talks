...
namespace UnitTests
{
    ...
    /// <summary>
    ///This is a test class for ChuckNorrisServiceTest and is intended
    ///to contain all ChuckNorrisServiceTest Unit Tests
    ///</summary>
	[TestClass()]
	public class ChuckNorrisServiceTest
	{
		...
		{
			ChuckNorrisService target = new ChuckNorrisService(); // TODO: Initialize to an appropriate value
